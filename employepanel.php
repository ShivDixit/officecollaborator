...
<body>
        ...
        <div class="header">
   <h1>Welcome to Employee Panel -<?php echo $_SESSION['AdminLoginId']?></h1> 
   <form method="POST" >
   <button name="Logout">Logout</button>
   
   <button name="Companies" formaction="company.php">Companies</button>
   <button name="Search" formaction="employesearch.php">Search</button>
    ...
    if(mysqli_num_rows($result) > 0){
        ...
        while($row = mysqli_fetch_array($result)){
            echo "<tr>";
                ...
                echo "<td><a href='updatepersonalemp.php?email=".$row['email']."'>Update</a></td>";
            echo "</tr>";
        }
        echo "</table>";
